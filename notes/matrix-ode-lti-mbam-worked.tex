\section{Worked notebook: covariance as geometry}

\subsection{Why covariance is a matrix}
...
\subsection{The duality with information}
...
\section{Worked notebook: projection and least squares}

\subsection{The nearest point problem}
...
\section{Worked notebook: matrix derivatives}

\subsection{Differentials first}
...
\section{Worked notebook: whitening and likelihood}

\subsection{Gaussian residuals}
...
\section{Worked notebook: identifiable combinations by SVD}
...
\subsection{A practical interpretation}
...
\section{Worked notebook: exponential decay}
...
\section{Worked notebook: sums of exponentials}

\subsection{Why they become sloppy}
...
\section{Worked notebook: sensitivity ODE}
...
\subsection{Why finite differences can mislead}
...
\section{Worked notebook: two-compartment dynamics}

\subsection{A minimal PK-like LTI system}
...
\section{Worked notebook: spring--mass--damper}
...
\section{Worked notebook: convolution}
...
\subsection{Relevance of memory}
...
\section{Worked notebook: stiffness}
...
\subsection{Model reduction view}
...
\section{Worked notebook: finite precision}

\subsection{Roundoff as perturbation}
...
\section{Worked notebook: regularization}
...
\subsection{Relation to Bayesian priors}
...
\section{Worked notebook: QR versus normal equations}

\subsection{Squaring the condition number}
...
\subsection{Model-fitting moral}
...
\section{Worked notebook: KL local expansion}

\subsection{One-dimensional sketch}
...
\subsection{Why the first-order term vanishes}
...
\section{Worked notebook: information projection}

\subsection{Projection between distributions}
...
\subsection{Model reduction reading}
...
\section{Worked notebook: model manifold for line fitting}

\subsection{A simple surface}
...
\subsection{Why nonlinear models are different}
...
\section{Worked notebook: geodesic boundaries}

\subsection{Local direction, nonlocal limit}
...
\subsection{The interpretive step}
...
\section{Worked notebook: boundary taxonomy}
...
\subsection{Why limits preserve meaning}
...
\section{Worked notebook: MBAM and Michaelis--Menten carefully}
...
\section{Worked notebook: active manifold}

\subsection{Training data versus query}
...
\subsection{The active subspace}
...
\section{Worked notebook: CRISP for QSP}

\subsection{A workflow}
...
\subsection{Regulatory style interpretation}
...
\section{Worked notebook: the full conceptual chain}

\subsection{From matrix to manifold}
