...
\begin{itemize}[leftmargin=2em]
  ...
  \item The \term{representation} is the mathematical probability law: \(\pksym{CL}_i=\pksym{CL}_{\pop}(\pksym{WT}_i/70)^\beta\exp(\eta_{\pklab{CL},i})\), \(\eta_i\sim\Normal(0,\Omega)\), and an observation density.
