...
\subsection{D'Argenio 在培训中给出的软件哲学 \tstamp{1: 00:18:13--00:21:34}}
...
\lecturefigure{adapt-background.jpg}{\tstamp{1: 00:18:58} ADAPT 背景与 BMSR 传统。}
...
\subsection{课程目标 \tstamp{1: 00:05:50--00:15:28}}
...
\lecturefigure{day1-agenda.jpg}{\tstamp{1: 00:11:16} Day 1 agenda: modeling background, simulation, estimation, debugging.}
...
\begin{enumerate}
  ...
  \item 午休后才进入 hierarchical/population modeling；目前这两份 transcript 没有包含下午部分。
\end{enumerate}
...
\subsection{三个基本问题 \tstamp{1: 00:23:46--00:29:33}}
...
\subsection{ADAPT 的核心模型形式 \tstamp{1: 00:43:33--00:51:25}}
...
\lecturefigure{state-output-equations.jpg}{\tstamp{1: 00:43:14} State equation 与 output equation 是 ADAPT 的核心语法。}
...
\subsection{ODE 之外还有 measurement model \tstamp{1: 00:56:45--00:58:47}}
...
\subsection{参数本身也可以有模型 \tstamp{1: 00:57:50--00:59:52}}
...
\subsection{Model file, data file, parameter file \tstamp{1: 01:05:20--01:30:00}}
...
\subsection{Indirect response simulation \tstamp{1: 01:53:20--02:18:40}}
...
\lecturefigure{indirect-response.jpg}{\tstamp{1: 01:52:56} 二室 PK 与 indirect response PD 的 simulation case study。}
...
\subsection{TMDD simulation \tstamp{1: 02:50:49--03:17:10}}
...
\lecturefigure{tmdd.jpg}{\tstamp{1: 02:50:30} Full TMDD model 的 simulation 入口。}
...
\subsection{Estimation 是 inverse problem \tstamp{1: 03:34:06--03:59:37}}
...
\subsection{Maximum likelihood 的统计含义 \tstamp{1: 04:00:00--04:13:12}}
...
\subsection{Bayesian/MAP estimation \tstamp{1: 04:13:39--04:36:56}}
...
\lecturefigure{bayesian-map.jpg}{\tstamp{1: 04:13:39} Prior, likelihood, posterior 与 MAP estimation 的图示。}
...
\subsection{Indirect response ML estimation \tstamp{1: 04:37:23--05:14:20}}
...
\subsection{Always simulate first \tstamp{1: 05:18:12--05:34:11}}
...
\lecturefigure{debugging.jpg}{\tstamp{1: 05:18:11} Debugging and advanced programming 的开场。}
...
\subsection{Inverse Gaussian absorption 的调试教训 \tstamp{1: 05:35:21--05:55:47}}
...
\subsection{把 AUC 和 time above threshold 写成 state \tstamp{1: 06:03:07--06:10:37}}
...
\subsection{PBPK 更准确地说是 circulatory model \tstamp{2: 00:15:39--00:23:06}}
...
\lecturefigure{pbpk-mass-balance.jpg}{\tstamp{2: 00:24:01} PBPK organ mass balance 与 perfusion-limited assumption。}
...
\subsection{PBPK 在 ADAPT 里的实现 \tstamp{2: 00:36:03--00:53:06}}
...
\subsection{Minimal PBPK with naive pooled data \tstamp{2: 01:24:32--01:45:01}}
...
\lecturefigure{naive-pooled-data.jpg}{\tstamp{2: 01:24:32} Minimal PBPK 的 naive pooled data estimation。}
...
\subsection{ACI and background mode \tstamp{2: 01:45:12--02:00:57}}
...
\subsection{Forward Monte Carlo \tstamp{2: 02:02:40--02:24:42}}
...
\subsection{Mean response is not response at mean parameter \tstamp{2: 02:31:17--02:33:45}}
...
\lecturefigure{population-nonlinearity.jpg}{\tstamp{2: 02:31:05} Population mean response 与 mean-parameter response 的非线性差异。}
