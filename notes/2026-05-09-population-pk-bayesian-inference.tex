...
{\small
  ...
  These notes connect the inference language of MIT 6.008/6.437 with Marc Lavielle's mixed effects population approach, but the final organizing object is not a course list.  It is the hierarchy
  \[
    \theta
    \longrightarrow
    \rpsi_i
...
The long version is only a careful unfolding of that sentence.  6.008 names the probability objects, 6.437 names the inference and decision operations, Lavielle names the mixed-effects hierarchy, and NONMEM/SAEM name historically important computational approximations.
