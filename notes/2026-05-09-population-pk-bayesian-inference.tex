...
{\small
  ...
  \vspace{5pt}
  \noindent\textbf{Style}\\
  This is a reconstruction rather than an excerpt. The notation borrows the 6.437 random-variable convention: Latin random quantities use sans-serif symbols, Greek random quantities use bold Greek, and realizations or candidate values use ordinary type. The Population PK structure follows Lavielle's \(y_i,\psi_i,\theta\) language.\hspace*{\fill}[notation]
}
...
\section{Probability laws and posterior updates}
